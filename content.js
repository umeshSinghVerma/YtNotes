...
// let asyncFunctionRunning = false;

const key = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imltb3p6cmxqd250YXBpY2ZhZXZwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTIzNzIxMDQsImV4cCI6MjAyNzk0ODEwNH0.aWtgF6G6gu7A0PzEvK08UzHZ5483WADMGR4q4n9o3sk'

const url = 'https://imozzrljwntapicfaevp.supabase.co'
const database = supabase.createClient(url, key)
let USER_ID = localStorage.getItem('YTNOTES_USER_ID');
if (!USER_ID) {
  USER_ID = crypto.randomUUID();
  localStorage.setItem('YTNOTES_USER_ID', USER_ID);
}
...
async function ContentScript() {
  ...
  MergeDiv.style.backgroundColor = '#272727';
  MergeDiv.style.marginBottom = '5px';
  MergeDiv.style.padding = '15px';
  MergeDiv.style.display = 'flex';
  MergeDiv.style.flexDirection = 'column';


  const MergeInput = document.createElement('input');
  MergeInput.style.border = '1px solid #CCCCCC';
  MergeInput.style.borderRadius = '3px';
  MergeInput.style.padding = '8px 10px';
  MergeInput.style.margin = '10px';
  MergeInput.style.fontSize = '14px';
  MergeInput.style.fontFamily = 'Arial, sans-serif';
  MergeInput.style.outline = 'none';
  MergeInput.style.boxShadow = 'inset 0 1px 2px rgba(0,0,0,0.1)';
  MergeInput.style.width = '300px';
  MergeInput.style.transition = 'border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out';
  MergeInput.id = 'MergeInput';
  MergeInput.placeholder = 'Enter the Video ID to merge';


  const MergeSubmit = document.createElement('button');
  MergeSubmit.style.backgroundColor = '#FF0000';
  MergeSubmit.style.margin = '10px';
  MergeSubmit.style.border = 'none';
  MergeSubmit.style.borderRadius = '3px';
  MergeSubmit.style.color = '#FFFFFF';
  MergeSubmit.style.padding = '8px 16px';
  MergeSubmit.style.fontSize = '14px';
  MergeSubmit.style.fontFamily = 'Arial, sans-serif';
  MergeSubmit.style.cursor = 'pointer';
  MergeSubmit.style.outline = 'none';
  MergeSubmit.style.transition = 'background-color 0.3s ease';
  MergeSubmit.innerHTML = "Merge";
  MergeSubmit.addEventListener('mousedown', function () {
    MergeSubmit.style.backgroundColor = '#CC0000';
  });

  MergeSubmit.addEventListener('mouseup', function () {
    MergeSubmit.style.backgroundColor = '#FF0000';
  });
  ...
  const copyVideoIdButton = document.createElement('button');

  // Apply styles to the button
  copyVideoIdButton.style.backgroundColor = '#FF0000';
  copyVideoIdButton.style.margin = '10px';
  copyVideoIdButton.style.border = 'none';
  copyVideoIdButton.style.borderRadius = '3px';
  copyVideoIdButton.style.color = '#FFFFFF';
  copyVideoIdButton.style.padding = '8px 16px';
  copyVideoIdButton.style.fontSize = '14px';

  copyVideoIdButton.style.fontFamily = 'Arial, sans-serif';
  copyVideoIdButton.style.cursor = 'pointer';
  ...
  copyVideoIdButton.addEventListener('mousedown', function () {
    copyVideoIdButton.style.backgroundColor = '#CC0000';
  });

  copyVideoIdButton.addEventListener('mouseup', function () {
    copyVideoIdButton.style.backgroundColor = '#FF0000';
  });

  const copyUserIdButton = document.createElement('button');

  // Apply styles to the button
  copyUserIdButton.style.backgroundColor = '#FF0000';
  copyUserIdButton.style.margin = '10px';
  copyUserIdButton.style.border = 'none';
  copyUserIdButton.style.borderRadius = '3px';
  copyUserIdButton.style.color = '#FFFFFF';
  copyUserIdButton.style.padding = '8px 16px';
  copyUserIdButton.style.fontSize = '14px';
  copyUserIdButton.style.fontFamily = 'Arial, sans-serif';
  copyUserIdButton.style.cursor = 'pointer';
  copyUserIdButton.style.outline = 'none';
  copyUserIdButton.style.transition = 'background-color 0.3s ease';

  // Button text
  copyUserIdButton.textContent = 'Copy Account ID';

  // Optional: Add a class for further styling
  copyUserIdButton.classList.add('youtube-button');

  // Add event listeners for the pressed effect
  copyUserIdButton.addEventListener('mousedown', function () {
    copyUserIdButton.style.backgroundColor = '#CC0000';
  });

  copyUserIdButton.addEventListener('mouseup', function () {
    copyUserIdButton.style.backgroundColor = '#FF0000';
  });
  ...
  div1.append(MergeInput, MergeSubmit, copyVideoIdButton, copyUserIdButton);
  ...
  UserInput.style.padding = '8px 10px';
  ...
  UserInput.style.boxShadow = 'inset 0 1px 2px rgba(0,0,0,0.1)';
  UserInput.style.width = '300px';
  UserInput.style.transition = 'border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out';
  UserInput.id = 'MergeInput';
  UserInput.placeholder = 'Account Id';


  const UserSubmit = document.createElement('button');
  UserSubmit.style.backgroundColor = '#FF0000';
  UserSubmit.style.margin = '10px';
  UserSubmit.style.border = 'none';
  UserSubmit.style.borderRadius = '3px';
  UserSubmit.style.color = '#FFFFFF';
  UserSubmit.style.padding = '8px 16px';
  UserSubmit.style.fontSize = '14px';
  UserSubmit.style.fontFamily = 'Arial, sans-serif';
  UserSubmit.style.cursor = 'pointer';
  UserSubmit.style.outline = 'none';
  UserSubmit.style.transition = 'background-color 0.3s ease';
  UserSubmit.innerHTML = 'Change Account';
  UserSubmit.addEventListener('mousedown', function () {
    UserSubmit.style.backgroundColor = '#CC0000';
  });

  UserSubmit.addEventListener('mouseup', function () {
    UserSubmit.style.backgroundColor = '#FF0000';
  });

  UserSubmit.addEventListener('click', () => {
    const UserIdValue = UserInput.value;
    if (UserIdValue) {
      USER_ID = UserIdValue;
      localStorage.setItem('YTNOTES_USER_ID', USER_ID);
      UserInput.value = '';
      alert('Account Id Changed Successfully');
    }
  })
  ...
  MergeDiv.append(div1, div2);
  MergeSubmit.onclick = async () => {
    //asyncFunctionRunning = true;
    const MergeId = MergeInput.value;
    MergeSubmit.innerHTML = "Loading....";
    ...
    alert('Video Notes Merged Successfully')
  }
  // const placeToAdd = document.getElementById('above-the-fold');
  // placeToAdd.prepend(MergeDiv);
  ...
  chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    const videoTitle = document.querySelector('#above-the-fold yt-formatted-string').innerHTML;
    if (message.action === "giveImageArray" && videoTitle) {
      if (message.pageUrl != currentLocation) {
        chrome.runtime.sendMessage({ ImagesArray: ImagesArray[currentLocation], url: currentLocation, videoTitle });
      } else {
        chrome.runtime.sendMessage({ ImagesArray: ImagesArray[currentLocation], url: currentLocation, videoTitle });
      }
    }
  ...
  button.id = 'capture';
  button.onclick = getPlayingScreenshot;
  ...
  setInterval(async () => {
    ...
    if (newLocation != currentLocation) {
      ...
      console.log("this is the previous data inside setTimeout", previousData);
      ImagesArray[currentLocation] = previousData;
  ...
  document.addEventListener('keydown', async (e) => {
    ...
    if (e.key === 'b' && e.ctrlKey) {
      ...
      console.log('this is screenshotUrl', screenshotUrl);
  ...
  async function MergeImageInDatabase() {
    ...
    if (extractVideoId(currentLocation)) {
      ...
      if (previousData && previousData.length > 0) {
        ...
        const videoTitle = document.querySelector('#above-the-fold yt-formatted-string').innerHTML;
        const res = await database.from('ImgArr').insert({
          Title: videoTitle,
          Url: currentLocation,
          Images: JSON.stringify(ImagesArray[currentLocation]),
          vidHash: extractVideoId(currentLocation),
          userId: USER_ID
        });
        // previousData = ImagesArray[currentLocation];
        console.log('this is newly added data', res);
      }
    }
    //asyncFunctionRunning = false;
  }
...
function extractVideoId(url) {
  var regex = /[?&]v=([a-zA-Z0-9_-]{11})/; // Regular expression to extract video ID
  var match = url.match(regex); // Match the URL against the regular expression
  if (match && match[1]) {
